...
export class ActivityUploadComponent implements OnInit, OnDestroy {
  ...
  onSearch(): void {
    ...
    this.fracApiService
      .searchEntities('activity', keyword, this.selectedLanguage)
      .subscribe({
        next: (res) => {
        ...
        "entity": [
          {
            "type": "activity",
            "code": "A1",
            "name": "Detect pregnancy and calculate Estimated Delivery Date of PW",
            "description": "Conducts initial assessment to identify pregnancy",
            "status": "Active",
            "children": []
          },
          {
            "type": "activity",
            "code": "A2",
            "name": "Conduct Antenatal Assessment of PW and identify High Risk Pregnancy",
            "description": "Conducts antenatal assessment",
            "status": "Active",
            "children": []
          },
          {
            "type": "activity",
            "code": "A3",
            "name": "Follow up and ensure early registration of pregnant women",
            "description": "Follow up and ensure early registration",
            "status": "Active",
            "children": []
          }
        ]

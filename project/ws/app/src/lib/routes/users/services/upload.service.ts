...
export class FileService implements OnDestroy {
  ...
  private readonly fileList: string[] = new Array<string>()
  private readonly fileList$: Subject<string[]> = new Subject<string[]>()
  private readonly displayLoader$: Subject<boolean> = new BehaviorSubject<boolean>(false)
